      ...
      <div className='page-footer'>
        <div className='row'>
          <div className='col-xs-12 col-sm-6'>
            <span className='txt-color-white'>Etechnologies Inc. © 2017</span>
          </div>
          ...
          <div className='col-xs-6 col-sm-6 text-right hidden-xs'>
            <div className='txt-color-white inline-block'>
              <i className='txt-color-blueLight hidden-mobile'>Last account activity <i
                className='fa fa-clock-o' /> &nbsp; <strong>0 mins ago &nbsp;</strong> </i>
              ...
              <Dropdown className='btn-group dropup' id='footer-progress-dropdown'>
                ...
                <Dropdown.Menu className='dropdown-menu pull-right text-left'>
                  ...
                  <MenuItem>
                    <div className='padding-5'>
                      <p className='txt-color-darken font-sm no-margin'>Memory Load
